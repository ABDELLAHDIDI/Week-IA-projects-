...
//     {
//         int j=0;
//         while(j<v.visited.size()){
//             
//             if( v.visited.indexOf(a) != -1)
//                if(v.visited.indexOf(a)-1<0)
//                     return i;
//         j++;
//         }
//         i++;
...
int i=0,k=0,w=0;
while(!v.fr.getFirst().equals(pf)  ){ 
    System.out.println("i= "+i+"\n");
    position x;
    while((x=v.getchild())!=null){
         System.out.println("w+i= "+i+w+++"\n");
...
if(k != 1) {
    System.out.println("\nles etapes sont : \n");
    v.fr.getFirst().afficher(v.fr.getFirst());}
else  {
System.out.println("\nles etapes sont :  \n");
v.fr.getLast().afficher(v.fr.getLast());}
...
//while(i<arbre.get(k).visited.size()){
//    System.out.println("\n"+arbre.get(k).visited.get(i)+"\n");
//  i++;
//}
//  k++;
//}
...
//          q++;
//           Iterator<position> itl =arbre.get(getindex(arbre, fin)).visited.iterator();
//       for(;itl.hasNext();){
//           position w= itl.next();
//           if(w.equals(pf)){
